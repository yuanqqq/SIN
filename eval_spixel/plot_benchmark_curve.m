...
% ================
% collect slic res
SLIC_res_path = './result_set/slic/bsd/' ;
num_list = [200:100:1200];
...
% 
%% collect LSC res
% LSC_res_path = './result_set/lsc/bsd/' ;
% cnt = 1; 
...
%% collect ERS res
n_set = 11
 ERS_res_path = './result_set/ers/bsd/' ;
...
% 
%% collect SNIC res 
snic_res_path = './result_set/snic/bsd/' ;
...
% 
% %% collect ETPS
% etps_res_path = './result_set/fcn/bsd/' ;
...
% 
%% collect SSN res
SSN_res_path = './result_set/ssn/bsd/' ;
num_list = [200:100:1200];
n_set = length(num_list);
...
% 
%% collect SEAL res
SEAL_res_path = './result_set/seal/bsd/' ;
...
fcn_res_path = './result_set/fcn/bsd/';
num_list = [54 96 150 216 294 384 486 600 726 864 1014 1176 1350 1536 1944]; 
% num_list = [300 432];
...
% please set the res_path appropriately before running
our1l_res_path = './result_set/deconv/bsd/';
num_list = [150 216 294 384 486 600 726 864 1014 1176 1350 1536 1944];
% num_list = [300 432];
% num_list = [300 432 588 768 972 1200 1452 1728 2028 2352];
n_set = length(num_list);
Ours = zeros(n_set,5);
...
xlim([0.75,0.95])
ylim([0.07,0.15])
set(gca,'XTick',(0.75:0.05:0.95),'FontName', 'ArialMT')
