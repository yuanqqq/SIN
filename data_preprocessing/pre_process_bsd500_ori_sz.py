...
parser.add_argument("--dataset", type=str, default='../BSD500/', help="where the dataset is stored")
parser.add_argument("--dump_root", type=str, default="../BSD500/ori_sz", help="Where to dump the data")
...
def dump_example(n, n_total, dataType, img_path):
    ...
    for k, label in enumerate(label_lst):
        ...
        dump_label_csv = os.path.join(dump_dir, 'map_csv',  '{0}_img-{1}.csv'.format(img_name, k))
